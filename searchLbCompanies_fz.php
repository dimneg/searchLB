...
<div class="row-fluid margin-bottom" align="center" >
 ...
 <form action="searchLbCompanies_fz.php?varKeyword=<?php if (isset($_POST['formKeyword'])) echo $_POST['formKeyword'];  else echo $_GET['varKeyword']?>"    method="post" accept-charset="UTF-8"> 
<p>			
